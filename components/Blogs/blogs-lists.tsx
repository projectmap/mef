...
export const BlogLists: FC<IBlogsLists> = ({ blogsLists }) => {
  ...
  return (
    ...
    <Container>
      ...
      <div className="flex">
        <button className="text-[16px] mt-[30px] bg-blue-600 text-center text-white text-[18px] mx-auto hover:opacity-50 border px-[50px] py-[20px] rounded-[80px]">See all blogs </button>
      </div>
      </Container>
          </div>
  );
